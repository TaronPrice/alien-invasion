...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #There is a way to use fullscreen mode on page 245
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to bullet collision."""
            #removes and bullets and aliens that have collided
    ...
    def _update_screen(self):
            ...
            #draw the play button if the game id inactive.
            if not self.stats.game_active:
                self.play_button.draw_button()

            # Make the most recent drawn screen display.
            pygame.display.flip()
